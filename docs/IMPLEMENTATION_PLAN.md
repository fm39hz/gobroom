...
| M13 | Canonical configuration bundle and sync | Partial; bundle foundation done | Versioned secret-free typed bundle export and reference validation are implemented. Add diff/dry-run, atomic apply/import, secret separation workflow and single-writer conflict semantics; do not imply conflict-free multi-master sync. |
