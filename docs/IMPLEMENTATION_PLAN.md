...
| M13 | Canonical configuration bundle and sync | Partial; bundle foundation done | Versioned secret-free typed bundle export, reference validation and dry-run diff are implemented. Add atomic apply/import, secret separation workflow and single-writer conflict semantics; do not imply conflict-free multi-master sync. |
