...
translation remain incomplete; the pure declared/guaranteed/available
projection contract is now implemented in the kernel but not yet exposed as a
control-plane view. Track
